...
const links = [
    ...
    },
    {
        ...
        items: [
            {
                title: '¿Que es un Mini Boulder?',
                href: '#',
            },
            {
                title: 'Por que escalar?',
                href: '#',
            },
            {
                title: 'Diseño',
    ...
    return (
        <footer className={cn(pathname === '/login'  && 'hidden' || pathname === '/signup' && 'hidden' || "border-b pt-20 dark:bg-transparent")}>
            <div className="mx-auto max-w-6xl px-6">
                ...
                <div className="mt-12 flex flex-wrap items-end justify-center gap-6 border-t py-6">
                    <span className="text-muted-foreground order-last block text-center text-sm md:order-first">© {new Date().getFullYear()} s.a.l. dev</span>
