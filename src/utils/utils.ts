...
export const productLabels: Record<string, ProductLabel> = {
  champaqui: {label: "Champaquí", img: CHAMPAQUI, img2: STICKERS_4PANELES, tomas: 20, paneles: 4, colors: 5, age: "3 a 6", price: "200.000"},
  aconcagua: {label: "Aconcagua", img: ACONCAGUA, img2: STICKERS_6PANELES, tomas:   30, paneles: 6, colors: 6, age: "3 a 8", price: "300.000"},
}
